...
<!-- Meta tag Keywords -->
<link href="<?php echo base_url('assets_login/css/style.css') ?>" rel="stylesheet" type="text/css" media="all"/><!--stylesheet-css-->
<link rel="stylesheet" href="<?php echo base_url('assets_login/css/font-awesome.css') ?>"><!--fontawesome-->
            ...
            <div class="wthree-container">
                <div class="wthree-form">
                    ...
                    <form action="<?php echo base_url('LoginAdmin')?>"" method="post">
                        ...
                        <div class="clear"></div>
                        <div class="w3l">
                            <span><a href="Login">College Login</a></span>  
                        </div>
                        <div class="clear"></div>
